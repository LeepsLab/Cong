...
/**
 * This is the root class for the config.  It contains a set of default fields
 * and values as well as the definition for a ConfigException which is thrown 
 * when the payoff function fails to configure.
 * @author jpettit
 */
