...
/**
 * This class provides a set of useful static functions for writing payoff functions
 * @author jpettit
 */
public class PayoffUtils {
    
    /**
     * Returns an array with a length equal to the size of the map of strategies
     * passed with the average of all of the strategies in each of the arrays
     * indices.  If excludeSelf is equal to true in the current config then the
     * average excludes then the strategy of the client who's id is passed is 
     * excluded from the average.
     * @param id of the client to be excluded if so specified in the config
     * @param strategies the strategies to average
     * @return an array with the average strategy in every spot
     */
