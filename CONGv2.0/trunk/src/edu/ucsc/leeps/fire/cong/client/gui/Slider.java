...
/**
 * Class describing a slider which can be used to select strategies.
 */
public class Slider {
    ...
    /**position of the slider's start on the x axis, if the alignment if vertical
     and the y axis if the alignments horizontal*/
    public float sliderStart;
    /**position of the slider's end on the x axis, if the alignment if vertical
     and the y axis if the alignments horizontal*/
    public float sliderEnd;
    /**position of the slider on the y axis, if the alignment if vertical
     and the x axis if the alignments horizontal*/
    public float sliderLine;
    ...
    /**
     * Uses an awt color object to set the color of this slider
     * @param c 
     */
    ...
    /**
     * Sets the strategy value in this slider.
     * @param newStrat 
     */
    ...
    /**
     * Sets whether a box is to be draw around the slider's handle
     * @param outline boolean indicating whether or not to outline the slider's handle
     */
    ...
    /**
     * Sets whether text indicating the number of the strategy is to be drawn next
     * to the slider's handle
     * @param showStrategyLabel boolean indicating whether or not to draw the strategy label
     */
