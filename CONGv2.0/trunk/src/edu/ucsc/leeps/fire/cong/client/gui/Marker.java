...
/**
 * Sprite used as a marker on charts.
...
public class Marker extends Sprite {
    ...
    /**
     * Enumerated type for the different ways that this marker can be drawn
     */
    ...
    /**
     * Enumerated type for the shape of the marker.  It can either be a circle
     * or a square.
     */
    public enum Shape {
    ...
    /**
     * Sets the draw mode of this marker
