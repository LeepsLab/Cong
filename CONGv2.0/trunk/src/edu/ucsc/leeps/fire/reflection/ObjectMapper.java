...
/**
 * This is a library that provides methods for loading the fields of config instances
 * from a csv file and for writing log event to a csv file.
 *
 * @author jpettit
 */
public class ObjectMapper {
    ...
    /**
     * Constructor
     * @param row the row the object mapper will look at in config files
     */
    ...
    /**
     * Loads the fields of a configuration file and assigns then to the fields of
     * the passed config object.
     * @param object a config object
     * @param row the row of the configuration file that is being loaded
     * @param store the config store object for this configuration file.  The store
     * object has the keys of the config object and a list of the rows.
     ...
     * @param w the buffered writer for the log file
     * @param delimiter the string used to delimit the columns of the log file
     * @throws IOException
    ...
    /**
     * Writes the fields and values of the passed object, delimited the the passed 
     * delimeter, to the buffered writer passed.  <code>flush()</code> is called
     * on the buffered writer at the end of this method.
     * @param o an object
     * @param w a buffered writer to be written to
     * @param delimiter
     * @throws IOException
     * @throws IllegalAccessException
     * @throws IllegalArgumentException
