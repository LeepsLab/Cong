...
/**
 * Provides the main method when starting a test of cong which is called by the 
 * session test dialogue.  Initializes the server and clients locally.
 * @author jpettit
...
public class Startup {
    ...
    /**
     * Main method for a test session
     * @param args
     * @param clients 
     */
    ...
    /**
     * This class describes a thread that redirects an input stream to System.err
     */
