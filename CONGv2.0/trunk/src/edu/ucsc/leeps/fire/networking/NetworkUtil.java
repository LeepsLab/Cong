...
/**
 * Provides methods creating the server and connecting clients to it
 * @author jpettit
 */
public class NetworkUtil {
    
    /**
     * Remotes the passed server controller to the local rmi registry with the 
     * name "server"
     */ 
    ...
    /**
     * Remotes the passed client controller and registers it with the server in 
     * addition to setting the name of the client controller.
     * @param controller 
     */
    public static void connectToServer(ClientController controller) {
        ...
        try {//creates an object proxy for the remote server
            server =
    ...
    /**
     * creates the ip_adress.txt file
     * @throws IOException 
     */
